...
exports.default = {
    ...
    async bootstrap({ strapi }) {
        ...
        if (!(publicRole === null || publicRole === void 0 ? void 0 : publicRole.id)) {
        ...
        try {
            ...
            strapi.log.warn(`[contact-form] Could not add public create permission (restart Strapi after adding the API). ${e}`);
        }
    },
};
